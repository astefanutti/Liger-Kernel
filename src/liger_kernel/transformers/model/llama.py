...
def lce_maybe_trainable_lm_head(self, hidden_states, hidden_size, labels, **loss_kwargs):
...
def _liger_for_causal_lm_loss(lm_head, hidden_states, hidden_size, labels, **loss_kwargs):
